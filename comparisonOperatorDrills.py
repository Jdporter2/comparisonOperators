...
k = 1 > 2
print(k)
#11) Check if 11 divided by three 3 is less than 100 divided by 33 and store the answer in variable l
var1 = (11/3) < (100/33)
print(var1)
#12) Check if 9 times 7 is greater than 8 times 8 and store the answer in variable m
varm = (9*7) > (8*8)
print(varm)
#13) Check if the square root of 3 is less than 1.15 squared and store the answer in variable n
varn = (3**(1/2)) < (1.15**2)
print(varn)
#14) Multiple 8 by 3 and store that in variable o, then divide 56 by 2 and store that in variable p, finally check if o is greater then p and store the answer in variable q.
varo = 8 * 3
varp = 56 / 2
varq = varo > varp
print(varq)
